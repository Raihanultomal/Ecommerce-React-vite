          ...
          <div className="row text-center align-items-center">
            <div className="col-lg-6 col-md-12 p-3">
              <div className="map card m-auto embed-responsive embed-responsive-16by9">
                <iframe
                  ...
                  src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Chittagong,%20Bangladesh+(E-commerce)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                >
            ...
            <div className="col-lg-6 col-md-12">
              <div className="card p-5">
                ...
                <p className="mb-2">
                  <b>Phone:</b>{' '}
                  <a className="footer-tel" href="tel: +8801521401218">
                    Call us at +8801521401218
                  </a>
                </p>
                <p className="mb-4">
